...
class Editor_model extends CI_Model {
    ...
    public function getEditorsByParams($page, $perpage, $search_key, $sort_field, $sort_sort){
        $this->db->select("*");
        $this->db->from($this->table);
        if($search_key!=""){
            $this->db->like('name', $search_key);
            $this->db->or_like('sirname', $search_key);
            $this->db->or_like('supervisor', $search_key);
    ...
    public function getEditorsTotal($search_key){
        $this->db->select("*");
        $this->db->from($this->table);
        if($search_key!=""){
            $this->db->like('name', $search_key);
