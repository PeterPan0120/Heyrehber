								...
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
											<?=$label['add_agency_review']?><small><?=$label['you_can_add_new_review_here']?></small>
										</h3>
									</div>
								</div>
							</div>
							<div class="m-portlet__body">
								<form class="form-agencies-add-agency-review m-form m-form--fit m-form--label-align-right">
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-8 col-md-9 col-sm-12">
											<textarea class="form-control m-input" name="review" id="exampleTextarea" rows="3" placeholder="<?=$label['please_write_down_review_of_this_agency']?>"></textarea>
										</div>
									</div>
									<div class="form-group m-form__group row">
