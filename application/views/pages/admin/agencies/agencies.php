					...
					<div class="m-content">
						<div class="m-portlet m-portlet--mobile">
								...
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
											<?=$label['agency_list']?><small><?=$label['you_can_see_all_agencies_here']?></small>
										</h3>
									</div>
								</div>
							</div>
							<div class="m-portlet__body">
								<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
									<div class="row align-items-center">
										...
										<div class="col-xl-4 order-1 order-xl-2 m--align-right">
											<a href="/admin/agencies_add_agency" class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
												<span>
													<i class="la la-plus"></i>
													<span><?=$label['add_agency']?></span>
												</span>
											</a>
												...
												<div class="col-md-2">
													<div class="m-form__group m-form__group--inline">
														...
														<div class="m-form__control">
															<select class="form-control m-bootstrap-select  m_selectpicker" id="select_filter_group">
								...
								<!--begin: Datatable -->
								<div class="m_datatable" id="m_agency_datatable"></div>
