										...
										<div class="tab-content">
												...
												<div class="m-widget4">
													...
													<div class="m-widget4__item">
														<div class="m-widget4__img m-widget4__img--pic">
															<img src="<?=base_url();?>assets/backend/app/media/img/users/100_4.jpg" alt="">
														</div>
													...
													<div class="m-widget4__item">
														<div class="m-widget4__img m-widget4__img--pic">
															<img src="<?=base_url();?>assets/backend/app/media/img/users/100_14.jpg" alt="">
														</div>
														<div class="m-widget4__info">
															<span class="m-widget4__title">
																Milano Esco
													...
													<div class="m-widget4__item">
														<div class="m-widget4__img m-widget4__img--pic">
															<img src="<?=base_url();?>assets/backend/app/media/img/users/100_11.jpg" alt="">
														</div>
														<div class="m-widget4__info">
															<span class="m-widget4__title">
																Nick Bold
													...
													<div class="m-widget4__item">
														<div class="m-widget4__img m-widget4__img--pic">
															<img src="<?=base_url();?>assets/backend/app/media/img/users/100_1.jpg" alt="">
														</div>
														<div class="m-widget4__info">
															<span class="m-widget4__title">
																Wiltor Delton
													...
													<div class="m-widget4__item">
														<div class="m-widget4__img m-widget4__img--pic">
															<img src="<?=base_url();?>assets/backend/app/media/img/users/100_5.jpg" alt="">
														</div>
														<div class="m-widget4__info">
															<span class="m-widget4__title">
																Nick Stone
											...
											<div class="tab-pane" id="m_widget4_tab2_content">
												...
												<div class="m-widget4">
													...
													<div class="m-widget4__item">
														<div class="m-widget4__img m-widget4__img--pic">
															<img src="<?=base_url();?>assets/backend/app/media/img/users/100_2.jpg" alt="">
														</div>
														<div class="m-widget4__info">
															<span class="m-widget4__title">
																Kristika Bold
													...
													<div class="m-widget4__item">
														<div class="m-widget4__img m-widget4__img--pic">
															<img src="<?=base_url();?>assets/backend/app/media/img/users/100_13.jpg" alt="">
														</div>
														<div class="m-widget4__info">
															<span class="m-widget4__title">
																Ron Silk
													...
													<div class="m-widget4__item">
														<div class="m-widget4__img m-widget4__img--pic">
															<img src="<?=base_url();?>assets/backend/app/media/img/users/100_9.jpg" alt="">
														</div>
														<div class="m-widget4__info">
															<span class="m-widget4__title">
																Nick Bold
													...
													<div class="m-widget4__item">
														<div class="m-widget4__img m-widget4__img--pic">
															<img src="<?=base_url();?>assets/backend/app/media/img/users/100_8.jpg" alt="">
														</div>
														<div class="m-widget4__info">
															<span class="m-widget4__title">
																Nick Bold
												...
												<div class="m-timeline-2__items  m--padding-top-25 m--padding-bottom-30">
													...
													<div class="m-timeline-2__item m--margin-top-30">
														...
														<div class="m-list-pics m-list-pics--sm m--padding-left-20">
															<a href="#"><img src="<?=base_url();?>assets/backend/app/media/img/users/100_4.jpg" title=""></a>
															<a href="#"><img src="<?=base_url();?>assets/backend/app/media/img/users/100_13.jpg" title=""></a>
															<a href="#"><img src="<?=base_url();?>assets/backend/app/media/img/users/100_11.jpg" title=""></a>
															<a href="#"><img src="<?=base_url();?>assets/backend/app/media/img/users/100_14.jpg" title=""></a>
														</div>
													</div>
													<div class="m-timeline-2__item m--margin-top-30">
