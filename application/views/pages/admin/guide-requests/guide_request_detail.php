							...
							<div class="m-portlet__body">
								<form class="form-guide-requests-guide-request-detail m-form m-form--fit m-form--label-align-right">
											...
											<label class="col-form-label">
												...
												if(isset($users)):
													foreach($users as $user):?>
														<?php 
														if($user->id == $guide_request->requester):
															echo $user->name;
														?>
														<?php endif;?>
													<?php endforeach;?>
									...
									<div class="m-form__actions">
										<a href="/admin/guide_requests_edit_guide_request?id=<?=$guide_request->id?>" class="btn btn-primary"> <?=$label['edit']?></a>
										<a href="/admin/guide_requests_guide_requests" class="btn btn-default"> <?=$label['cancel']?></a>
									</div>
								</form>
							</div>
						</div>
