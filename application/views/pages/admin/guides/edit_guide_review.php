								...
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
											<?=$label['edit_guide_review']?><small><?=$label['you_can_edit_this_review_here']?></small>
										</h3>
									</div>
								</div>
							</div>
							<div class="m-portlet__body">
								<form class="form-guides-edit-guide-review m-form m-form--fit m-form--label-align-right">
											...
											<select class="form-control m-bootstrap-select m_selectpicker" name="guide">
												<?php if(isset($guides)):
													foreach($guides as $guide):?>
														<?php if($guide->id == $guide_review->guide):?>
											...
											<select class="form-control m-bootstrap-select m_selectpicker" name="agency">
												<?php if(isset($agencies)):
													foreach($agencies as $agency):?>
														<?php if($agency->id == $guide_review->agency):?>
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-8 col-md-9 col-sm-12">
											<textarea class="form-control m-input" name="review" id="exampleTextarea" rows="3" placeholder="<?=$label['please_write_down_review']?>..."><?=$guide_review->review;?></textarea>
										</div>
									</div>
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-8 col-md-9 col-sm-12">
											...
											<input type="hidden" name="rating" class="awesomeRatingValue" value="<?=$guide_review->rating;?>">
										</div>
									</div>
									<div class="form-group m-form__group row">
