								...
								<form class="form-museums-museum-details m-form m-form--fit m-form--label-align-right">
									<div class="row">
										<div class="col-lg-8">
											...
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-3 col-sm-12"><?=$label['created_date']?>:</label>
												<div class="col-lg-8 col-md-9 col-sm-12">
													<label class="col-form-label"><?=$museum->created_date?></label>
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-3 col-sm-12"><?=$label['status']?>:</label>
												<div class="col-lg-8 col-md-9 col-sm-12">
													<label class="col-form-label">
														<?php
														if($museum->status=="active") echo $label['active'];
									...
									<div class="m-form__actions">
										<a href="/admin/museums_edit_museum?id=<?=$museum->id?>" class="btn btn-primary"><?=$label['edit']?></a>
										<a href="/admin/museums_museums" class="btn btn-default"><?=$label['cancel']?></a>
									</div>
								</form>
							</div>
						</div>
