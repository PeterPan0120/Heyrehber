								...
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
											<?=$label['edit_restaurant']?><small><?=$label['you_can_edit_this_restaurant_here']?></small>
										</h3>
									</div>
								</div>
							</div>
									...
									<div class="row">
										<div class="col-lg-7">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-lg-8 col-md-9 col-sm-12">
													<input class="form-control m-input" type="number" name="points" placeholder="<?=$label['points']?>" value="<?=$restaurant->points;?>">
												</div>
											</div>
											<div class="form-group m-form__group row">
										...
										<div class="col-lg-12">
											<div class="form-group m-form__group row">
												...
												<div class="col-lg-9 col-md-9 col-sm-12">
													<div action="/admin/upload_restaurant_images" method="post" name="images[]" class="dropzone" id="restaurant_dropzone" enctype="multipart/form-data">
				                                        ...
				                                        <div class="dz-preview dz-processing dz-image-preview dz-success dz-complete dz-preview-<?=array_search($image, $images)?>">
				                                            ...
				                                            <div class="dz-details">
				                                                ...
				                                                <div class="dz-filename">
				                                                    <span data-dz-name><?=str_replace("uploads/restaurant/", "", $image->path);?></span>
				                                                </div>
				                                            </div>
