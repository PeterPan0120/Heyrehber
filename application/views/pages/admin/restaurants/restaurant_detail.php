					...
					<div class="m-content">
						<div class="m-portlet m-portlet--mobile">
							...
							<div class="m-portlet__body">
								<form class="form-restaurants-restaurant-details m-form m-form--fit m-form--label-align-right">
									...
									<div class="row">
										<div class="col-lg-7">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-lg-8 col-md-9 col-sm-12">
													<label class="col-form-label"><?=$restaurant->points?></label>
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['created_date']?>:</label>
												<div class="col-lg-8 col-md-9 col-sm-12">
													<label class="col-form-label"><?=$restaurant->created_date?></label>
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['active']?>:</label>
												<div class="col-lg-8 col-md-9 col-sm-12">
													<span class="m-switch m-switch--outline m-switch--icon m-switch--success">										<?php if($restaurant->status=="active"):?>
									...
									<div class="m-form__actions">
										<a href="/admin/restaurants_edit_restaurant?id=<?=$restaurant->id?>" class="btn btn-primary"> <?=$label['edit']?></a>
										<a href="/admin/restaurants_restaurants" class="btn btn-default"> <?=$label['cancel']?></a>
									</div>
								</form>
							</div>
						</div>
