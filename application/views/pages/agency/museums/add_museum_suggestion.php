					...
					<div class="m-content">
						<div class="m-portlet m-portlet--mobile">
							...
							<div class="m-portlet__body">
								<form class="form-museums-add-museum-suggestion m-form m-form--fit m-form--label-align-right">
									<div class="row">
										<div class="col-lg-8">
											...
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['summer_time']?></label>
											...
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['winter_time']?></label>
												<div class="col-lg-3 col-md-9 col-sm-12">
											...
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['rest_day_in_summer']?></label>
											...
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['rest_day_in_winter']?></label>
												<div class="col-lg-8 col-md-9 col-sm-12">
													<label class="m-checkbox m-checkbox--solid m-checkbox--success">
											...
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['entrance_price']?></label>
												<div class="col-lg-7 col-md-9 col-sm-12">
											...
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['museum_web']?></label>
												<div class="col-lg-7 col-md-9 col-sm-12">
											...
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['museum_email']?></label>
												<div class="col-lg-7 col-md-9 col-sm-12">
													<input class="form-control m-input" type="text" name="email" placeholder="<?=$label['museum_email']?>" required>
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['museum_phone_number']?></label>
												<div class="col-lg-7 col-md-9 col-sm-12">
