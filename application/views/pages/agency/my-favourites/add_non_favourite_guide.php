								...
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
											<?=$label['add_non_favourite_guide']?><small><?=$label['you_can_add_non_favourite_guide_here']?></small>
										</h3>
									</div>
								</div>
							</div>
							<div class="m-portlet__body">
								<form class="form-my-favourites-add-non-favourite-guide m-form m-form--fit m-form--label-align-right">
