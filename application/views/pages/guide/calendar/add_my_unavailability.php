								...
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
											<?=$label['add_unavailable_days']?><small><?=$label['you_can_add_your_unavailable_days_here']?></small>
										</h3>
									</div>
								</div>
							</div>
							<div class="m-portlet__body">
								<form class="form-calendar-add-my-unavailability m-form m-form--fit m-form--label-align-right">
