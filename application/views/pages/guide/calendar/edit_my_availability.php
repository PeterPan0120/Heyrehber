								...
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
											<?=$label['edit_available_days']?><small><?=$label['you_can_edit_your_available_days_here']?></small>
										</h3>
									</div>
								</div>
							</div>
							<div class="m-portlet__body">
								<form class="form-calendar-edit-my-availability m-form m-form--fit m-form--label-align-right">
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-5 col-md-9 col-sm-12">
											<select class="form-control m-bootstrap-select m_selectpicker" name="days" id="select_my_availability_days">
												...
												<?php endif;?>
												<?php if($guide_availability->days=="One Day"):?>
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-5 col-md-9 col-sm-12">
											...
											<input type="text" class="form-control" name="from" id="m_datepicker_1" readonly placeholder="<?=$label['from']?>" value="<?=date('d.m.Y', strtotime($guide_availability->from))?>"/>
											<?php else:?>
											<input type="text" class="form-control" name="from" id="m_datepicker_1" data-date-language="tr" readonly placeholder="<?=$label['from']?>" value="<?=date('d.m.Y', strtotime($guide_availability->from))?>"/>
											<?php endif;?>
										</div>
									</div>
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-5 col-md-9 col-sm-12">
											<?php if($this->session->userdata('site_lang')=="english"):?>
												...
												<?php else:?>
												<input type="text" class="form-control" name="to" id="m_datepicker_1" readonly placeholder="<?=$label['to']?>" value="<?=date('d.m.Y', strtotime($guide_availability->to))?>"/>
												<?php endif;?>
											<?php else:?>
												<?php if($guide_availability->days=="One Day"):?>
												...
												<?php else:?>
												<input type="text" class="form-control" name="to" id="m_datepicker_1" data-date-language="tr" readonly placeholder="<?=$label['to']?>" value="<?=date('d.m.Y', strtotime($guide_availability->to))?>"/>
												<?php endif;?>
											<?php endif;?>
										</div>
									</div>
