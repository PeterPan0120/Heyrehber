							...
							<div class="m-portlet__body">
								<form class="form-guide-requests-add-guide-request m-form m-form--fit m-form--label-align-right">
									...
									<div class="form-group m-form__group row">
										...
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control" name="start_date" id="m_datepicker_1" readonly placeholder="Select date" />
										</div>
									</div>
									<div class="form-group m-form__group row">
										<label class="col-form-label col-lg-3 col-sm-12"><?=$label['finish_date']?></label>
										<div class="col-lg-4 col-md-9 col-sm-12">
											<input type="text" class="form-control" name="finish_date" id="m_datepicker_1" readonly placeholder="Select date" />
										</div>
									</div>
									<div class="form-group m-form__group row">
