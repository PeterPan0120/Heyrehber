							...
							<div class="m-portlet__body">
								<form class="form-guide-requests-edit-guide-request m-form m-form--fit m-form--label-align-right">
									...
									<div class="m-form__actions">
										...
										<a href="/guide/guide_requests_edit_guide_request?id=<?=$guide_request->id?>" class="btn btn-primary"> <?=$label['edit']?></a>
										<a href="/guide/guide_requests_my_guide_requests" class="btn btn-default"> <?=$label['cancel']?></a>
									</div>
								</form>
							</div>
						</div>
