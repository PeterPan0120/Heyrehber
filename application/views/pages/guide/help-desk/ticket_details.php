						...
						<div class="m-content col-lg-8">
									...
									<div class="m-portlet__head-caption">
										<div class="m-portlet__head-title">
											<h3 class="m-portlet__head-text"">
												<i class="flaticon flaticon-exclamation" style="color:red; font-size: 20px"></i><?=$label['this_ticket_is_closed_by_admin']?>
											</h3>
										</div>
									</div>
								</div>
							...
							<?php if(isset($messages)):?>
								...
								<div class="m-portlet m-portlet--mobile">
									...
									<div class="m-portlet__body"><!-- Çıkış, ömür, ğümşüç -->
							...
							<div class="add-reply-message m-portlet m-portlet--mobile">
								...
								<div class="m-portlet__body add-reply-message-body hide">
									<form class="form-message-reply" accept-charset="utf-8">
