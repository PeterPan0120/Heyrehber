								...
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
											<?=$label['add_non_favourite_agency']?><small><?=$label['you_can_add_non_favourite_agency_here']?></small>
										</h3>
									</div>
								</div>
							</div>
							<div class="m-portlet__body">
								<form class="form-my-favourites-add-non-favourite-agency m-form m-form--fit m-form--label-align-right">
