								...
								<div class="m-portlet__head-caption">
									<div class="m-portlet__head-title">
										<h3 class="m-portlet__head-text">
											<?=$label['add_shop_suggestion']?><small><?=$label['you_can_add_shop_suggestion_here']?></small>
										</h3>
									</div>
								</div>
							</div>
							<div class="m-portlet__body">
								<form class="form-shops-add-shop m-form m-form--fit m-form--label-align-right">
									<div class="row">
										<div class="col-lg-7">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-lg-8 col-md-9 col-sm-12">
													<textarea class="form-control m-input" name="description" id="exampleTextarea" rows="5" placeholder="<?=$label['please_write_down_description_of_this_shop']?>"></textarea>
												</div>
											</div>
											<div class="form-group m-form__group row">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-lg-8 col-md-9 col-sm-12">
													<input class="form-control m-input" type="text" name="number" placeholder="<?=$label['shop_phone_number']?>">
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['shop_web']?></label>
												<div class="col-lg-8 col-md-9 col-sm-12">
													<input class="form-control m-input" type="text" name="web" placeholder="<?=$label['shop_web']?>">
												</div>
											</div>
											<div class="form-group m-form__group row">
												<label class="col-form-label col-lg-4 col-sm-12"><?=$label['shop_email']?></label>
												<div class="col-lg-8 col-md-9 col-sm-12">
													<input class="form-control m-input" type="text" name="email" placeholder="<?=$label['shop_email']?>" required>
												</div>
											</div>
											<div class="form-group m-form__group row">
