					...
					<div class="m-content">
						<div class="m-portlet m-portlet--mobile">
							...
							<div class="m-portlet__body">
								<form class="form-shops-shop-suggestion-detail m-form m-form--fit m-form--label-align-right">
									<div class="row">
										<div class="col-lg-7">
											...
											<div class="form-group m-form__group row">
												...
												<div class="col-lg-8 col-md-9 col-sm-12">
													...
													<?php
													if($shop->status=="active") echo $label['active'];
									...
									<div class="m-form__actions">
										<a href="/guide/shops_shops" class="btn btn-default"><?=$label['cancel']?></a>
									</div>
								</form>
							</div>
						</div>
