...
<!--                         <li><a href="/auth/login">Registration</a></li> -->
                    </ul>
                </div>
                <!-- END TOP BAR MENU -->
            </div>
            ...
            <div class="tab-content">
              <div class="tab-pane row fade in active" id="tab-1">
                <div class="col-md-3 col-sm-3">
                  <a href="<?=base_url();?>assets/frontend/temp/photos/img7.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
              ...
              <div class="tab-pane row fade" id="tab-2">
                ...
                <div class="col-md-3 col-sm-3">
                  <a href="<?=base_url();?>assets/frontend/temp/photos/img10.jpg" class="fancybox-button" title="Image Title" data-rel="fancybox-button">
