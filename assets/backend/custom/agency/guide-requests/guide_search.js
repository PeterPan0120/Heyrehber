    ...
    init:function() {
        ...
        t=$("#m_guide_search_datatable").mDatatable( {
            data: {
                ...
                source: {
                    read: {
                        url: "/agency/guides_getGuideSearch",
            ...
            columns:[ 
                ...
                }, 
                {
                    ...
                    template:function(t, e, a) {
                        ...
                        return  '\t\t\t\t\t\t'+
                                '<a href="/agency/guide_search_guide_details?id='+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-warning m-btn--icon m-btn--icon-only m-btn--pill" title="View Details">'+
                                    '\t\t\t\t\t\t\t'+
                                    '<i class="la la-eye"></i>'+
                                    '\t\t\t\t\t\t'+
                                '</a>'+
