    ...
    init:function() {
        ...
        t=$("#m_my_ticket_datatable").mDatatable( {
            data: {
                ...
                source: {
                    read: {
                        url: "/agency/help_desk_getMyTickets",
            ...
            columns:[ 
                ...
                }, 
                {
                    ...
                    width:120, 
                    template: function(t){
                        return "<a href='/agency/help_desk_my_ticket_details?id="+t.id+"' title='"+t.subject+"'>"+t.subject+"</a>";
                    }
                }, 
                {
                    field:"priority", 
                ...
                }, 
                {
                    ...
                    template:function(t, e, a) {
                        ...
                        return  '\t\t\t\t\t\t'+
                                '<a href="/agency/help_desk_my_ticket_details?id='+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-warning m-btn--icon m-btn--icon-only m-btn--pill" title="View Details">'+
                                    '\t\t\t\t\t\t\t'+
                                    '<i class="la la-eye"></i>'+
                                    '\t\t\t\t\t\t'+
                                '</a>'+
...
jQuery(document).ready(function() {
    ...
    $("#m_my_ticket_datatable").on("click", "a[title='Delete']", function(){
        ...
        swal({
            ...
            e.value
            ? window.location.href="/agency/help_desk_delete_ticket?id="+id
