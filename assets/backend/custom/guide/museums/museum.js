        ...
        t=$("#m_museum_datatable").mDatatable( {
            ...
            columns:[ 
                ...
                },
                {
                    ...
                    width:100, 
                    template: function(t){
                        return "<a href='/guide/museums_museum_detail?id="+t.id+"'>"+t.name+"</a>";
                    }
                }, 
                {
                ...
                }, 
                {
                    ...
                    template:function(t, e, a) {
                        return  '\t\t\t\t\t\t'+
                                '<a href="/guide/museums_museum_detail?id='+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-warning m-btn--icon m-btn--icon-only m-btn--pill" title="View Details">'+
                                    '\t\t\t\t\t\t\t'+
                                    '<i class="la la-eye"></i>'+
                                    '\t\t\t\t\t\t'+
                                '</a>'+
