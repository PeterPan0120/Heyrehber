        ...
        t=$("#m_shop_datatable").mDatatable( {
            ...
            columns:[ 
                ...
                }, 
                {
                    ...
                    width:80, 
                    template: function(t){
                        return "<a href='/guide/shops_shop_detail?id="+t.id+"'>"+t.name+"</a>";
                    }
                }, 
                {
                    field:"category", 
                ...
                }, 
                {
                    ...
                    template:function(t, e, a) {
                        ...
                        return  '\t\t\t\t\t\t'+
                                '<a href="/guide/shops_shop_detail?id='+t.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-warning m-btn--icon m-btn--icon-only m-btn--pill" title="View Details">'+
                                    '\t\t\t\t\t\t\t'+
                                    '<i class="la la-eye"></i>'+
                                    '\t\t\t\t\t\t'+
                                '</a>'+
